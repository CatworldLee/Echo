const settings = {
    ...
    // CSD/ICL controls
    "enable_csd_collection": true, // true: generate and save CSD after task completion. ICAL is run separately via tasks/run_icl_flow.py
    "icl_top_k": 3,
    "icl_weights": {"attr": 1, "struct": 1, "func": 1, "proc": 1, "inter": 1}
